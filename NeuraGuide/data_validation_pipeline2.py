...
class DataValidator:
    ...
    def __init__(self, df, essential_fields=None, flag_fields=None, url_column='Website'):
        self.df = df
    ...
    def data_validation_process(self):
        ...
        #Handle missing data
        self.find_missing_essential()
        self.find_missing_flagged()
        self.get_missing_summary()
        self.remove_incomplete()
        self.flag_incomplete()
